...
export const ChatErrorBanner: React.FC<ChatErrorBannerProps> = ({
  ...
  // Don't show retry button for hardware/device limitation errors
  const isHardwareLimitation = error.includes("doesn't fully support") || 
                                error.includes("experimental and missing") ||
                                error.includes("not available on your device");
